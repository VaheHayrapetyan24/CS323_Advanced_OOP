...
bool MovementIterator::make_step() {
    ...
    // std::cout << "Rotating tibia by " << d_tibia / steps << std::endl;
    ...
    std::cout << "Femur slope after rotation: " << body.get_l_femur().get_line().slope() << std::endl;
    std::cout << "Tibia slope after rotation: " << body.get_l_tibia().get_line().slope() << " target slpe " << tibia_angle << std::endl;
    completed_steps++;
